  ...
  return (
    ...
    >
      <div className="z-10 items-stretch justify-start flex-col flex box-border relative">
        <div className="box-border flex relative mt-18 md:mt-20 w-full justify-center text-white items-stretch">
          <div className="flex flex-row justify-center items-center w-full bg-gray-800">
            <div className="flex flex-col justify-center h-full w-full border-r-[0.5px] border-r-gray-700">
              <div className="items-center w-full flex-col flex justify-start box-border relative rounded-r-none pb-2 border-b-3 border-b-blue-500">
                <div className="items-center md:mt-4 w-full flex-col flex justify-start box-border relative">
                      ...
                      !matchup.road.icon.startsWith(
                        ...
                        <div className="flex">
                          <img
                            ...
                            className="w-20 h-20 border-transparent border rounded-[40px]"
                          />
                        </div>
                      ) : (
                        <div
              ...
              <div className="w-full flex flex-col justify-center text-center">
                ...
                <div className="flex flex-col w-full justify-start mt-2 border-t-2 border-t-gray-400">
            ...
            <div className="flex flex-col justify-center h-full w-full border-l-[0.5px] border-l-gray-700">
              <div className="items-center w-full flex-col flex justify-start box-border relative rounded-r-none pb-2 border-b-3 border-b-blue-500">
                <div className="items-center mt-4 w-full flex-col flex justify-start box-border relative ">
                  <div className="bg-gray-800 items-center w-full flex-col flex justify-start box-border relative">
                    <div className="bg-no-repeat bg-center bg-contain w-full justify-center flex ">
                  ...
                  {matchup.home.top_5.map((player, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-row justify-start text-4xl w-full">
                        ...
                        <div className="flex w-6/8 justify-start flex-col">
                          <div className="flex flex-row justify-start items-center text-left">
                            <span className="text-xl flex flex-col justify-start items-start">
                              {player.name}
                            </span>
                          </div>
                          <div className="flex flex-col justify-end w-full">
