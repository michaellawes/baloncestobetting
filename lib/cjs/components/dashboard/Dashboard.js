...
import { createPlayerSpecials, getDailySlate, getDaysSinceLastMonday, } from "../../utils/Util";
import { Specials } from "./Specials";
export function Dashboard(props) {
    var _this = this;
    var weeklySlate = props.weeklySlate, setIsViewingDashboard = props.setIsViewingDashboard, lockout = props.lockout, setCurrentMatchup = props.setCurrentMatchup, setIsViewingMatchup = props.setIsViewingMatchup, setMatchup = props.setMatchup, setWeeklySlate = props.setWeeklySlate, setSpecials = props.setSpecials, specials = props.specials;
    ...
    useEffect(function () {
        ...
        var getMatchup = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, data, error, weeklySlate_1, getSpecials, getSharedSlip;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(!lockout && !data[0]["is_done"])) return [3 /*break*/, 4];
                        return [4 /*yield*/, getDailySlate(data[0]["id"])];
                    case 2:
                        weeklySlate_1 = _b.sent();
                        getSpecials = createPlayerSpecials(weeklySlate_1);
    ...
    return (_jsx("div", { className: tasks.length > 0
            ...
            : "w-full h-screen bg-gray-900", children: lockout || weeklySlate.length === 0 ? (_jsx(Lockout, { message: lockout
                ? getDaysSinceLastMonday() == 6
                    ? "Please wait while we process last week's results..."
                    : "Please wait while we process yesterday's results..."
                : "Please wait while we load today's slate..." })) : (_jsxs(_Fragment, { children: [specials.length > 0 && _jsx(Specials, { players: specials }), _jsx(WeeklySlate, { matchups: weeklySlate, isDiscountsAvailable: specials.length > 0, setCurrentMatchup: setCurrentMatchup })] })) }));
}
