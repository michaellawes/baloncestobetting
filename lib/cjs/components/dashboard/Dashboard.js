...
export function Dashboard(props) {
    var weeklySlate = props.weeklySlate, setIsViewingDashboard = props.setIsViewingDashboard, lockout = props.lockout;
    ...
    return (_jsx("div", { className: tasks.length > 0
            ...
            : "w-full h-screen bg-gray-900", children: lockout ? _jsx(Lockout, {}) : _jsx(WeeklySlate, { matchups: weeklySlate }) }));
}
