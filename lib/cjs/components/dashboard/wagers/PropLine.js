...
export function PropLine(props) {
    var text = props.text, odds = props.odds, frontend_id = props.frontend_id, oppId = props.oppId, team = props.team, betType = props.betType, isHome = props.isHome, isClose = props.isClose;
