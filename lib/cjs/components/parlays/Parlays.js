...
import { evaluateLeg, propField } from "../../utils/Util";
import { TasksDispatchContext } from "../reducer/TasksContext";
export function Parlays(props) {
    var _this = this;
    var setBalance = props.setBalance, setParlayFieldUpdate = props.setParlayFieldUpdate, user = props.user, setIsViewingDashboard = props.setIsViewingDashboard, matchups = props.matchups;
    var _a = React.useState([]), parlays = _a[0], setParlays = _a[1];
    var _b = React.useState(new Map()), liveTeamData = _b[0], setLiveTeamData = _b[1];
    var _c = React.useState(true), dataLoaded = _c[0], setDataLoaded = _c[1];
    var getTeamData = function (live_matchups) {
        ...
        for (var _i = 0, live_matchups_1 = live_matchups; _i < live_matchups_1.length; _i++) {
            ...
            teamData.set(matchup.road.name, new Map([
                ...
                [
                    ...
                    matchup.road.top_5[0].prop_line.text,
                ],
                [
                    "".concat(matchup.road.top_5[1].name, "_score"),
                    matchup.road.top_5[1].prop_line.text,
                ],
                [
                    "".concat(matchup.road.top_5[2].name, "_score"),
                    matchup.road.top_5[2].prop_line.text,
                ],
                [
                    "".concat(matchup.road.top_5[3].name, "_score"),
                    matchup.road.top_5[3].prop_line.text,
                ],
                [
                    "".concat(matchup.road.top_5[4].name, "_score"),
                    matchup.road.top_5[4].prop_line.text,
                ],
            ]));
            teamData.set(matchup.home.name, new Map([
                ...
                [
                    ...
                    matchup.home.top_5[0].prop_line.text,
                ],
                [
                    "".concat(matchup.home.top_5[1].name, "_score"),
                    matchup.home.top_5[1].prop_line.text,
                ],
                [
                    "".concat(matchup.home.top_5[2].name, "_score"),
                    matchup.home.top_5[2].prop_line.text,
                ],
                [
                    "".concat(matchup.home.top_5[3].name, "_score"),
                    matchup.home.top_5[3].prop_line.text,
                ],
                [
                    "".concat(matchup.home.top_5[4].name, "_score"),
                    matchup.home.top_5[4].prop_line.text,
                ],
            ]));
        }
        return teamData;
    ...
    var validateFinishedSlips = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var newlyExpiredParlays, expiredParlays, _i, data_1, parlay, startOfExpirationDate, processedData, _a, newlyExpiredParlays_1, parlay, processedParlay;
