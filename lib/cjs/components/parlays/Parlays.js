...
export function Parlays(props) {
    ...
    var validateFinishedSlips = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var newlyExpiredParlays, activeSlips, expiredParlays, _i, data_1, parlay, processedData, totalWinnings, _a, newlyExpiredParlays_1, parlay, processedParlay, newBalance, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    _b.label = 6;
                case 6: return [2 /*return*/, processedData.sort(function (a, b) {
