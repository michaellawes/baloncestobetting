...
import { getIndividualLegResultForParlays, getTeamData, } from "../../utils/Util";
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!(expiredParlays.length > 0)) return [3 /*break*/, 5];
                    _a = 0, expiredParlays_1 = expiredParlays;
                    _c.label = 1;
                case 1:
                    if (!(_a < expiredParlays_1.length)) return [3 /*break*/, 5];
                    parlay = expiredParlays_1[_a];
                    if (!parlay.legs[0].lastValue) return [3 /*break*/, 2];
                    processedData.push(parlay);
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, getIndividualLegResultForParlays(parlay)];
                case 3:
                ...
                case 4:
                    ...
                    return [3 /*break*/, 1];
                case 5:
                    if (!(newlyExpiredParlays.length > 0)) return [3 /*break*/, 10];
                    _b = 0, newlyExpiredParlays_1 = newlyExpiredParlays;
                    _c.label = 6;
                case 6:
                    if (!(_b < newlyExpiredParlays_1.length)) return [3 /*break*/, 10];
                    parlay = newlyExpiredParlays_1[_b];
                    if (!parlay.legs[0].lastValue) return [3 /*break*/, 7];
                    processedData.push(parlay);
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, validateResultOfFinishedSlips(parlay)];
                case 8:
                    processedParlay = _c.sent();
                    processedData.push(processedParlay);
                    _c.label = 9;
                case 9:
                    _b++;
                    return [3 /*break*/, 6];
                case 10: return [2 /*return*/, processedData.sort(function (a, b) { return b.created_at - a.created_at; })];
            }
        });
    }); };
