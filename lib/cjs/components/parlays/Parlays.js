...
import { evaluateLeg, getIndividualLegResultForParlays, getTeamData, } from "../../utils/Util";
...
export function Parlays(props) {
    ...
    var validateFinishedSlips = function (data) { return __awaiter(_this, void 0, void 0, function () {
        var newlyExpiredParlays, activeSlips, expiredParlays, _i, data_1, parlay, startOfExpirationDate, processedData, _a, expiredParlays_1, parlay, processedParlay, _b, newlyExpiredParlays_1, parlay, processedParlay;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    processedData = activeSlips;
                    if (!(expiredParlays.length > 0)) return [3 /*break*/, 4];
                    _a = 0, expiredParlays_1 = expiredParlays;
                    _c.label = 1;
                case 1:
                    if (!(_a < expiredParlays_1.length)) return [3 /*break*/, 4];
                    parlay = expiredParlays_1[_a];
                    return [4 /*yield*/, getIndividualLegResultForParlays(parlay)];
                case 2:
                    processedParlay = _c.sent();
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    if (!(newlyExpiredParlays.length > 0)) return [3 /*break*/, 8];
                    _b = 0, newlyExpiredParlays_1 = newlyExpiredParlays;
                    _c.label = 5;
                case 5:
                    if (!(_b < newlyExpiredParlays_1.length)) return [3 /*break*/, 8];
                    parlay = newlyExpiredParlays_1[_b];
                ...
                case 7:
                    _b++;
                    return [3 /*break*/, 5];
                case 8: return [2 /*return*/, processedData.sort(function (a, b) { return b.created_at - a.created_at; })];
            }
        });
    }); };
    var validateResultOfFinishedSlips = function (parlay) { return __awaiter(_this, void 0, void 0, function () {
        var matchup_id, query_ids, _a, data, error, legDictionary, _i, _b, leg, slipHit_1, updateSlip;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 1:
                    ...
                    for (_i = 0, _b = parlay.legs; _i < _b.length; _i++) {
                        leg = _b[_i];
                        leg.didHit = evaluateLeg(leg, legDictionary[leg.team + "/" + leg.betType]);
                    }
                    slipHit_1 = parlay.legs.every(function (leg) { return leg.didHit; });
    ...
    useEffect(function () {
        ...
        var getParlays = function () { return __awaiter(_this, void 0, void 0, function () {
            var userId, _a, data, error, validatedSlips;
