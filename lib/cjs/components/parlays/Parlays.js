...
export function Parlays(props) {
    var _this = this;
    var setBalance = props.setBalance, setParlayFieldUpdate = props.setParlayFieldUpdate, user = props.user, setIsViewingDashboard = props.setIsViewingDashboard, matchups = props.matchups, setIsViewingMatchup = props.setIsViewingMatchup, setNotification = props.setNotification, matchup = props.matchup;
    ...
    var _d = React.useState(false), hasNoParlays = _d[0], setHasNoParlays = _d[1];
    var _e = React.useState("ACTIVE"), currentFilter = _e[0], setCurrentFilter = _e[1];
