...
export function Navbar(props) {
    var isLoggedIn = props.isLoggedIn, setIsLoggedIn = props.setIsLoggedIn, balance = props.balance, setBalance = props.setBalance, setUser = props.setUser;
    ...
    return (_jsxs("nav", { className: "bg-gray-900 text-white w-full z-60", children: [_jsxs("div", { className: "container flex flex-row mx-auto px-4 md:flex items-center gap-6", children: [_jsx("a", { href: "#", className: "py-5 w-5/8 px-2 text-white flex-1 font-bold", children: _jsx(Link, { to: "/", children: "CnB Baloncesto Betting" }) }), _jsxs("span", { className: "py-2 px-3 w-2/8 block font-[ProximaNova-Bold, serif]", children: ["$", balance] }), _jsxs(Menu, { as: "div", className: "relative inline-block w-1/8", children: [_jsx(MenuButton, { className: "cursor-pointer inline-flex w-full justify-center gap-x-1.5 rounded-md text-sm font-semibold text-white", children: _jsx(Auth, { isLoggedIn: isLoggedIn, profileImg: profileImg }) }), _jsx(MenuItems, { transition: true, className: "absolute right-0 z-60 mt-2 w-56 origin-top-right rounded-md bg-gray-900 outline-1 -outline-offset-1 outline-white/10 transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in", children: _jsxs("div", { className: "py-1", children: [isLoggedIn && (_jsx(MenuItem, { children: _jsx("a", { href: "#", className: "block px-4 py-2 text-sm text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", children: _jsx(Link, { to: "/", children: "Return to Dashboard" }) }) })), isLoggedIn && (_jsx(MenuItem, { children: _jsx("a", { href: "#", className: "block px-4 py-2 text-sm text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", children: _jsx(Link, { to: "/parlays", children: "View Parlays" }) }) })), isLoggedIn && (_jsx(MenuItem, { children: _jsx("a", { href: "#", className: "block px-4 py-2 text-sm text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", onClick: handleLogout, children: "Log Out" }) })), !isLoggedIn && (_jsx("form", { action: "#", method: "POST", children: _jsx(MenuItem, { children: _jsx("button", { type: "submit", className: "block w-full px-4 py-2 text-left text-sm text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", children: _jsx(GoogleLogin, { onSuccess: function (credentialResponse) {
