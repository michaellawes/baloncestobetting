...
export function Navbar(props) {
    var isLoggedIn = props.isLoggedIn, setIsLoggedIn = props.setIsLoggedIn, balance = props.balance, setBalance = props.setBalance, setUser = props.setUser, isViewingDashboard = props.isViewingDashboard, isViewingMatchup = props.isViewingMatchup, matchup = props.matchup;
    ...
    return (_jsxs("nav", { className: !isViewingMatchup
            ? "bg-gray-900 text-white w-full fixed z-60 scrollbar-hide border-b-gray-300 border-b-1"
            : "bg-gray-900 text-white w-full fixed z-60 scrollbar-hide border-b-gray-600 border-b-1", children: [_jsxs("div", { className: "flex-row py-4 items-center flex justify-start box-border relative", children: [_jsx("div", { className: "flex flex-row grow justify-start w-6/10 md:w-10/20", children: _jsxs(Link, { className: "px-4 justify-start text-start text-white flex-1 flex-row font-bold", to: "/", children: [_jsx("span", { className: "", children: window.innerWidth < 469
                                        ? "CnB Fantasy Bets"
                                        : "CnB Baloncesto Betting" }), _jsxs("span", { className: "text-xs md:text-sm text-gray-400 pl-1", children: ["Week ", matchup >= 0 ? matchup : ""] })] }) }), _jsx("div", { className: "flex flex-row grow justify-end w-2/10 md:w-7/20", children: _jsxs("span", { className: "px-3 flex font-[ProximaNova-Bold, serif]", children: ["$", numberWithCommas(parseFloat(balance.toFixed(2)))] }) }), _jsxs(Menu, { as: "div", className: "flex flex-row grow justify-end px-4 relative w-2/10 md:w-3/20", children: [_jsx(MenuButton, { className: "cursor-pointer inline-flex rounded-md hover:bg-gray-800 focus:outline-none text-base px-2 py-2 focus-visible:ring-1 focus-visible:ring-gray-800", children: _jsx(Auth, { isLoggedIn: isLoggedIn, profileImg: profileImg }) }), _jsx(MenuItems, { transition: true, className: "absolute right-0 mr-2 z-65 mt-12 w-46 origin-top-right rounded-md bg-gray-900 outline-1 outline-gray-400 -outline-offset-1  transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in", children: _jsxs("div", { className: "", children: [isLoggedIn && (_jsxs("div", { children: [_jsx(MenuItem, { children: _jsx(Link, { className: "block px-4 py-2 text-sm text-end text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", to: "/", children: "Return to Dashboard" }) }), _jsx(MenuItem, { children: _jsx(Link, { className: "block px-4 py-2 text-sm text-end text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", to: "/parlays", children: "View Parlays" }) }), _jsx(MenuItem, { children: _jsx(Link, { to: "/", onClick: handleLogout, className: "block px-4 py-2 text-sm text-end text-gray-300 data-focus:bg-white/5 data-focus:text-white data-focus:outline-hidden", children: _jsx("span", { children: "Log Out" }) }) })] })), !isLoggedIn && (_jsxs("form", { action: "#", method: "POST", children: [_jsx(MenuItem, { children: _jsx("button", { type: "submit", className: "block w-full mr-4 bg-transparent", children: _jsx(GoogleLogin, { onSuccess: function (credentialResponse) {
