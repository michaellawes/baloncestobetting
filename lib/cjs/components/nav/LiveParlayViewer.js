...
export function LiveParlayViewer(props) {
    ...
    var getContainsCinemaLeg = function () {
        if (tasks.length > 0) {
            return tasks.some(function (leg) {
    ...
    var getParlayContainsDiscount = function () {
        return tasks.some(function (leg) {
            return leg.special_leg_type !== undefined &&
                leg.special_leg_type === specialLegTypes[1];
        });
    };
    var getMeetsDiscountMinimumLegs = function () {
        if (tasks.some(function (leg) {
            return leg.special_leg_type !== undefined &&
                leg.special_leg_type === specialLegTypes[1];
        })) {
