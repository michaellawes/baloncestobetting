...
import { generateId, propField } from "./utils/Util";
...
export function App() {
    ...
    var _f = useState(false), supabaseAuthenticated = _f[0], setSupabaseAuthenticated = _f[1];
    var _g = useState(0), matchup = _g[0], setMatchup = _g[1];
    var _h = useState([]), weeklySlate = _h[0], setWeeklySlate = _h[1];
    ...
    var _p = useState(true), showConfirmation = _p[0], setShowConfirmation = _p[1];
    useEffect(function () {
    ...
    var _q = useReducer(tasksReducer, []), tasks = _q[0], dispatch = _q[1];
    // Submit Parlay
    useEffect(function () {
