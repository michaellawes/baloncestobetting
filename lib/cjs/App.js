...
export function App() {
    ...
    var _m = useReducer(tasksReducer, []), tasks = _m[0], dispatch = _m[1];
    // Submit Parlay
    useEffect(function () {
    ...
    return (_jsx(Router, { children: _jsx(TasksContext, { value: tasks, children: _jsxs(TasksDispatchContext, { value: dispatch, children: [_jsx(Navbar, { isLoggedIn: isLoggedIn, setIsLoggedIn: setIsLoggedIn, balance: balance, setBalance: setBalance, setUser: setUser, errorMessage: errorMessage }), _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Dashboard, { weeklySlate: weeklySlate }) }), _jsx(Route, { path: "/parlays", element: _jsx(Parlays, { setBalance: setBalance, user: user, setParlayFieldUpdate: setParlayFieldUpdate, setErrorMessage: setErrorMessage }) })] })] }) }) }));
}
export default App;
