import { IndividualLineMetadata, MatchupSchema, ParlayTask, Player, SqlParlayMetadata, SupabaseParlay } from "./Interfaces";
export declare const getNewPropLineGivenDiscountAndType: (type: string, value: string, original: IndividualLineMetadata, live_total: number) => IndividualLineMetadata;
export declare const createPlayerSpecials: (weeklySlate: MatchupSchema[]) => Player[];
...
export declare const exportAsImage: (element: HTMLElement, legs: HTMLElement, imageFileName: string) => Promise<void>;
...
export declare const getDiscountFromType: (type: string) => string;
export declare const getFinalGameFormatted: (lastGame: string) => string;
...
export declare const getPlayerNameIsTooLong: (playerName: string, isSpecial: boolean) => boolean;
...
export declare const getTodayIsLastDay: (lastGame: string) => boolean;
...
export declare const isPlayerLockedOut: (lastGame: string) => boolean;
export declare const isTeamScoreLockedOut: (lastFirstGame: number) => boolean;
