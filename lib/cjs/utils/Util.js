...
export var getParlaysWithLegs = function (fbParlays) { return __awaiter(void 0, void 0, void 0, function () {
    var frontendParlays, allParlayIds, allParlayLegs, parlayIdToLegs, _i, allParlayLegs_1, leg, propId, propTokens, newLeg, legs, newLegs, _a, allParlayIds_1, parlayId, sortedLegs, _b, fbParlays_1, parlay, frontendParlay;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                frontendParlays = [];
