            ...
            top_5: [
                {
                    ...
                    live_total: 140,
                    team: "TOR",
                    fantasy_team_name: "BOY",
                    last_game: "",
                    status: "ACTIVE",
                    average: 58.8,
                    games_left: 1,
                    has_special_prop_today: false,
                    position: "SF",
...
export var progressBarWidth = new Map([
    [
        "0",
        "h-[4px] z-40 bg-blue-900 bases-0 grow flex-row box-border rounded-l-md relative w-0/100",
    ],
    [
        "1",
        "h-[4px] z-40 bg-blue-900 bases-0 grow flex-row box-border rounded-l-md relative w-1/100",
    ],
    [
        "2",
...
export var specialLegTypes = ["CINEMA", "DISCOUNT"];
export var discountTypes = ["LINE REDUCTION", "ODDS BOOST", "OVER", "UNDER"];
export var lineReductionDiscounts = [
    "15",
    "30",
    "25",
    "15",
...
export var oddsBoost = ["50", "75", "150", "100", "50", "100", "50"];
